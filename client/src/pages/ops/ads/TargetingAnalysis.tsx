...
export default function TargetingAnalysis({ campaignId, campaignIds, campaignNamesList, marketplace, reportDate, startDate, endDate, defaultAdType }: TargetingAnalysisProps) {
  ...
  const { data, isLoading } = trpc.adLocalAnalysis.getTargetingAnalysisLocal.useQuery({
