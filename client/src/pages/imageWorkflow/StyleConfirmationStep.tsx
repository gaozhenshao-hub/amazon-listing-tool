...
import { BookOpen, Check, Grid3X3, Loader2, Lock, Palette, RotateCcw, Sparkles, Unlock, X } from "lucide-react";
import { useEffect, useState } from "react";
import { toast } from "sonner";

import { KbImagePickerDialog } from "./KnowledgeImagePickerDialog";
import { AsinSetPickerDialog, KbStyleTagPickerDialog } from "./StyleReferenceDialogs";
...
export function Step3StyleConfirm({
  ...
  return (
    <div className="space-y-4">
      ...
      {(allStyleOptions.length > 0) && !generationJob.isGenerating && (
        <div className="space-y-4">
          {/* 模式提示横幅 */}
          {aiResult?.mode === "kb" ? (
