...
- [ ] 自动补齐最近六个月缺失的领星ASIN日数据：先识别美国站授权店铺的日期缺口并分段MCP读取；仅在覆盖完整、无截断、身份/字段/异常校验通过时自动追加日快照，异常保留人工草稿
- [ ] 按周分段补齐2026-02-26至2026-08-09及2026-08-24共166个缺失日：每段独立审计、可恢复、自动确认追加日快照；店铺覆盖不足、限流/超时、分页截断、身份/字段/波动异常均不得自动写入
