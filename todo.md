...
- [ ] 读取空气套件当前Step4会话快照、参考图任务结果与当前Step2大纲
- [ ] 核验主图、辅图2至7、A+ 1至7及独立品牌故事的参考图覆盖、连续编号和内容非空
- [ ] 核验Step4参考图与Step5图片建议的模块映射一致性
- [ ] 修复发现的参考图遗漏、历史水合或编号展示差异
- [ ] 用空气套件前台确认Step4参考图完整展示
- [ ] 将空气套件Step4的26条历史imageReferences收敛为当前大纲的主图、辅图2至7、A+ 1至7和独立品牌故事，移除A+ 8起及4.1等历史残留
